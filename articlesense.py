...
st.set_page_config(
    page_title="ArticleSense: Chat with Your Articles 📰",
    page_icon="📰",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Add CSS styles to improve the interface
st.markdown(
    """
    <style>
    .stApp {
...
# Title and sidebar setup with new font and design
st.title("📰 ArticleSense: Chat with Your Articles 🌐")
st.sidebar.title("Enter Your Article URLs 📎")

# Sidebar input fields for up to 3 URLs
...
# Custom bot name input field
bot_name = st.sidebar.text_input("Name your bot:", value="InsightBot")
...
def setup_chain(vector_store):
    llm = Ollama(model="llama2")  # Use Ollama with LLaMA 2 model
